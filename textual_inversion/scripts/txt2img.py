...
if __name__ == "__main__":
    ...
    config = OmegaConf.load("textual_inversion/configs/latent-diffusion/txt2img-1p4B-eval_with_tokens.yaml")  # TODO: Optionally download from same location as ckpt and chnage this logic
